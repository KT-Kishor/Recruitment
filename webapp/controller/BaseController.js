sap.ui.define([
...
], function (Controller, JSONModel, Formatter, BusyIndicator) {
  "use strict";
  ...
  return Controller.extend("sap.kt.ktofferletter.products.controller.BaseController", {
    ...
    onAttachmentsTableDelete: function (oEvent) {
      ...
      if (aItems.length === 0) {
        sap.ui.getCore().byId("SendMail_Button").setEnabled(false);
      } else {
        sap.ui.getCore().byId("SendMail_Button").setEnabled(true);
      }
    },
    ...
    onPressCC: function (oEvent) {
      ...
      let birthdayMessage =
        ...
        Your dedication and positivity make the workplace better every day.<br/>
        May this year bring new achievements and happiness your way.<br/>
